...
public class CipherMetaDataHolder {
    ...
    public void setCipherBase64Encoded(byte[] cipher) {
        this.c = Arrays.toString(Base64.getEncoder().encode(cipher));
    }
    ...
    public byte[] getSelfContainedCiphertextWithIv(byte[] originalCipher, byte[] iv) {
        ...
        cipherInitializationVectorHolder.setCipher(Arrays.toString(Base64.getEncoder().encode(originalCipher)));
        cipherInitializationVectorHolder.setInitializationVector(Arrays.toString(Base64.getEncoder().encode(iv)));
     ...
     * to metadata in com.migration.CipherMetaDataHolder object.
     *
